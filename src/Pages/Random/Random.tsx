...
function Random() {
  ...
  const Random: Gif = useSelector((state: any) => state.Random);
            ...
            <>
              <div className={detailStyles.detailUserImageContainer}>
                ...
                <svg
                  ...
                  onClick={() => {
                    window.location.href = `${Random.user.instagram_url}`;
                  }}
                >
